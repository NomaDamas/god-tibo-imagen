...
test("production manifest contains twelve complete five-family zones", async () => {
  ...
  assert.deepEqual(production.archetypes, [
    ...
    { zoneId: "08", slug: "tray-blob" },
    { zoneId: "08", slug: "toaster-pup" },
    { zoneId: "08", slug: "cup-drone" },
    { zoneId: "08", slug: "kitchen-server" },
    { zoneId: "08", slug: "boiler-chef" },
    { zoneId: "09", slug: "dust-bunny" },
    { zoneId: "09", slug: "laundry-hound" },
    { zoneId: "09", slug: "hanger-bat" },
    { zoneId: "09", slug: "dorm-manager" },
    { zoneId: "09", slug: "wardrobe-keeper" },
    { zoneId: "10", slug: "balloon-sprout" },
    { zoneId: "10", slug: "parade-hound" },
    { zoneId: "10", slug: "confetti-kite" },
    { zoneId: "10", slug: "stage-helper" },
    { zoneId: "10", slug: "carousel-brute" },
    { zoneId: "11", slug: "buoy-pod" },
    { zoneId: "11", slug: "fin-runner" },
    { zoneId: "11", slug: "lifeguard-drone" },
    { zoneId: "11", slug: "pool-attendant" },
    { zoneId: "11", slug: "wave-machine" },
    { zoneId: "12", slug: "starling-orb" },
    { zoneId: "12", slug: "comet-hound" },
    { zoneId: "12", slug: "orbit-kite" },
    { zoneId: "12", slug: "observatory-aide" },
    { zoneId: "12", slug: "telescope-giant" },
  ]);
  ...
  assert.equal(produced.length, 240);
